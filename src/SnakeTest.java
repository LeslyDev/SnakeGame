...
public class SnakeTest {
    ...
    public void chooseDirection() {
        Snake snake = new Snake(new ImageIcon("green.jpg").getImage(), 50, 50, "right");
        snake.initSnake();
    ...
    public void checkCollisions() {
        // змея укусила себя
        Snake falseSnake1 = new Snake(new ImageIcon("green.jpg").getImage(), 50, 50, "right");
        ...
        Snake falseSnake2 = new Snake(new ImageIcon("green.jpg").getImage(), 50, 50, "right");
        ...
        Snake trueSnake = new Snake(new ImageIcon("green.jpg").getImage(), 50, 50, "right");
    ...
    public void checkTouch() {
        ...
        Snake snake1 = new Snake(new ImageIcon("green.jpg").getImage(), 50, 50, "right");
        snake1.initSnake();
        Snake snake2 = new Snake(new ImageIcon("green.jpg").getImage(), 50, 50, "right");
        ...
        Snake snake3 = new Snake(new ImageIcon("green.jpg").getImage(), 100, 100, "right");
        snake3.initSnake();
        Snake snake4 = new Snake(new ImageIcon("green.jpg").getImage(), 50, 50, "right");
        snake4.initSnake();
